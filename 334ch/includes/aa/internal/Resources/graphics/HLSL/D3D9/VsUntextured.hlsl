#include "VertexInputTextureless.hlsli"
#include "VertexOutputTextureless.hlsli"

VertexOutputTextureless main(VertexInputTextureless input, uniform float3 cameraPos, uniform float4x4 wvp, uniform float4x4 worldInv)
{
