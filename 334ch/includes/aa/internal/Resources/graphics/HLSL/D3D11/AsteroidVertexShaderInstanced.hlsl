#include "AsteroidVertexInputInstanced.hlsli"
#include "VertexOutputInstanced.hlsli"

VertexOutputInstanced main(AsteroidVertexInputInstanced input, uniform float3 cameraPos, uniform float4x4 viewProj)
{
